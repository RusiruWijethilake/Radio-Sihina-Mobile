package lk.microlion.dev.radiosihina.utils;
...
import lk.microlion.dev.radiosihina.R;
...
public class RadioService extends Service implements Player.Listener, AudioManager.OnAudioFocusChangeListener {
    ...
    public void onCreate() {
        ...
        AdaptiveTrackSelection.Factory trackSelectionFactory = new AdaptiveTrackSelection.Factory().createTrackSelections();
        AdaptiveTrackSelection.Factory trackSelectionFactory = new AdaptiveTrackSelection.Factory(bandwidthMeter);
        DefaultTrackSelector trackSelector = new DefaultTrackSelector(trackSelectionFactory);
        exoPlayer = ExoPlayer.Builder(getApplicationContext(), trackSelector);
